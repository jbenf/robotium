...
class WebElementCreator {
	...
	/**
	 * Prepares for start of creating {@code TextView} objects based on web
	 * elements
	 */
	...
	/**
	 * Returns true if all {@code TextView} objects based on web elements have
	 * been created
	 * 
	 * @return true if all {@code TextView} objects based on web elements have
	 *         been created
	 */
	 ...
	 * 
	 * @param isFinished
	 *            true if all {@code TextView} objects have been created
	 */
	 ...
	 * @param webView
	 *            the {@code WebView} the text is shown in
	 */
	 ...
	 * 
	 * @param webElement
	 *            the {@code TextView} object to set location
	 * @param webView
	 *            the {@code WebView} the text is shown in
	 * @param x
	...
	private void setLocation(WebElement webElement, WebView webView, int x, int y, int width, int height) {
		...
		webElement.setWidth((int) (width * scale));
		webElement.setHeight((int) (height * scale));
	}
	 ...
	 *            the data of the web element
	 * @param webView
	 *            the web view the text is shown in
	 * 
