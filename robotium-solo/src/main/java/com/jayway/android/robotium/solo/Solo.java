 ...
 * 
 * Robotium has full support for Views, WebViews, Activities, Dialogs, Menus and
 * Context Menus.
 * 
...
public class Solo {
	 ...
	 * @param activity
	 *            the start {@link Activity} or {@code null} if no Activity is
	 *            specified
	 * 
	 */
	 ...
	 * @return {@code true} if text is displayed and {@code false} if it is not
	 *         displayed before the timeout
	 * 
	 */
	 ...
	 * 
	 * @param id
	 *            the R.id of the {@link View} to wait for
	...
	/**
	 * Waits for a View matching the specified class. Default timeout is 20
	 * seconds.
	 * 
	 * @param viewClass
	...
	/**
	 * Waits for a WebElement matching the specified By object. Default timeout
	 * is 20 seconds.
	 * 
	 * @param by
	 *            the By object. Examples are: {@code By.id("id")} and
	 *            {@code By.name("name")}
	 * @return {@code true} if the {@link WebElement} is displayed and
	 *         {@code false} if it is not displayed before the timeout
	 * 
	 */
	 ...
	 * @param timeout
	 *            the amount of time in milliseconds to wait
	 * @return {@code true} if condition is satisfied and {@code false} if it is
	 *         not satisfied before the timeout
	 * 
	 */
	...
	/**
	 * Searches for a text in the EditText objects currently displayed and
	 * returns true if found. Will automatically scroll when needed.
	 * 
	 * @param text
	 *            the text to search for
	 * @return {@code true} if an {@link EditText} displaying the specified text
	 *         is found or {@code false} if it is not found
	 * 
	 */
	 ...
	 * {@code true} if at least one Button is found. Will automatically scroll
	 * when needed.
	 * 
	 * @param text
	 *            the text to search for. The parameter will be interpreted as a
	 *            regular expression
	 * @return {@code true} if a {@link Button} displaying the specified text is
	 ...
	 *            the text to search for. The parameter will be interpreted as a
	 *            regular expression
	 * @return {@code true} if a {@link ToggleButton} displaying the specified
	 *         text is found and {@code false} if it is not found
	 * 
	 */
	...
	/**
	 * Searches for a Button displaying the specified text and returns
	 * {@code true} if the searched Button is found a specified number of times.
	 ...
	 *            found
	 * @return {@code true} if a {@link Button} displaying the specified text is
	 *         found a specified number of times and {@code false} if it is not
	 *         found
	 * 
	 */
	...
	/**
	 * Searches for a ToggleButton displaying the specified text and returns
	 * {@code true} if the searched ToggleButton is found a specified number of
	 ...
	 *            found
	 * @return {@code true} if a {@link ToggleButton} displaying the specified
	 *         text is found a specified number of times and {@code false} if it
	 *         is not found
	 * 
	 */
	...
	/**
	 * Searches for the specified text and returns {@code true} if at least one
	 * item is found displaying the expected text. Will automatically scroll
	 * when needed.
	 * 
	 * @param text
	 *            the text to search for. The parameter will be interpreted as a
	...
	/**
	 * Searches for the specified text and returns {@code true} if the searched
	 * text is found a specified number of times. Will automatically scroll when
	 * needed.
	 * 
	 * @param text
	 *            the text to search for. The parameter will be interpreted as a
	 ...
	 *            matches means that one or more matches are expected to be
	 *            found
	 * @return {@code true} if text is found a specified number of times and
	 *         {@code false} if the text is not found
	 * 
	 */
	...
	/**
	 * Searches for the specified text and returns {@code true} if the searched
	 * text is found a specified number of times.
	 * 
	 * @param text
	 *            the text to search for. The parameter will be interpreted as a
	 *            regular expression.
	 ...
	 * 
	 * @param orientation
	 *            the orientation to set. <code>Solo.</code>{@link #LANDSCAPE}
	 *            for landscape or <code>Solo.</code>{@link #PORTRAIT} for
	 *            portrait.
	 * 
	 */
	 ...
	 * @param name
	 *            the name of the {@link Activity} that is expected to be
	 *            active. Example is: {@code "MyActivity"}
	 * 
	 */
	 ...
	 *            the message to display if the assert fails
	 * @param activityClass
	 *            the class of the Activity that is expected to be active.
	 *            Example is: {@code MyActivity.class}
	 * 
	 */
	...
	/**
	 * Asserts that the Activity matching the specified name is active, with the
	 ...
	 *            the message to display if the assert fails
	 * @param name
	 *            the name of the Activity that is expected to be active.
	 *            Example is: {@code "MyActivity"}
	 * @param isNewInstance
	...
	/**
	 * Asserts that the Activity matching the specified class is active, with
	 * the possibility to verify that the expected Activity is a new instance of
	 * the Activity.
	 * 
	 * @param message
	 *            the message to display if the assert fails
	...
	@SuppressWarnings("unchecked")
	public void assertCurrentActivity(String message, @SuppressWarnings("rawtypes") Class activityClass, boolean isNewInstance) {
	 ...
	 * 
	 * @return {@code true} if the {@link android.app.Dialog} is opened before
	 *         the timeout and {@code false} if it is not opened
	 * 
	 */
	 ...
	 * 
	 * @param index
	 *            the index of the {@link ImageButton} to click. 0 if only one
	 *            is available
	 * 
	 */
	 ...
	 * 
	 * @param text
	 *            the text displayed by the {@link ToggleButton}. The parameter
	 ...
	 * 
	 * @param text
	 *            the text displayed by the MenuItem. The parameter will be
	 ...
	 *            interpreted as a regular expression
	 * @param subMenu
	 *            {@code true} if the menu item could be located in a sub menu
	 * 
	 */
	...
	/**
	 * Presses a MenuItem matching the specified index. Index {@code 0} is the
	 * first item in the first row, Index {@code 3} is the first item in the
	 * second row and index {@code 6} is the first item in the third row.
	 * 
	 * @param index
	 *            the index of the {@link android.view.MenuItem} to press
	 * 
	 */
	...
	/**
	 * Presses a MenuItem matching the specified index. Supports three rows with
	 * a specified amount of items. If itemsPerRow equals 5 then index 0 is the
	 * first item in the first row, index 5 is the first item in the second row
	 * and index 10 is the first item in the third row.
	 * 
	 * @param index
	 *            the index of the {@link android.view.MenuItem} to press
	 * @param itemsPerRow
	 ...
	 * 
	 * @param spinnerIndex
	 *            the index of the {@link Spinner} menu to use
	 * @param itemIndex
	 *            the index of the {@link Spinner} item to press relative to the
	 *            currently selected item. A Negative number moves up on the
	 *            {@link Spinner}, positive moves down
	 * 
	 */
	 ...
	 *            the {@link View} to click
	 * @param immediately
	 *            {@code true} if View should be clicked without any wait
	 */
	 ...
	 * 
	 * @param text
	 *            the text to click. The parameter will be interpreted as a
	 *            regular expression
	 * 
	 */
	 ...
	 *            regular expression
	 * @param match
	 *            if multiple objects match the text, this determines which one
	 *            to click
	 * 
	 */
	...
	/**
	 * Long clicks a View or WebElement displaying the specified text. Will
	 * automatically scroll when needed.
	 * 
	 * @param text
	 *            the text to click. The parameter will be interpreted as a
	 ...
	 * from the context menu that appears. Will automatically scroll when
	 * needed.
	 * 
	 * @param text
	 *            the text to click. The parameter will be interpreted as a
	 *            regular expression
	 * @param index
	 *            the index of the menu item to press. {@code 0} if only one is
	 *            available
	 * 
	 */
	...
	/**
	 * Long clicks the specified list line in the ListView matching the
	 * specified index and returns an ArrayList of the TextView objects that the
	 * list line is displaying.
	 * 
	 * @param line
	 *            the line to click
	 * @param index
	...
	/**
	 * Zooms in or out if startPoint1 and startPoint2 are larger or smaller then
	 * endPoint1 and endPoint2. Requires API level >= 14.
	 * 
	 * @param startPoint1
	...
	/**
	 * Draws two semi-circles at the specified centers. Both circles are larger
	 * than rotateSmall(). Requires API level >= 14.
	 * 
	 * @param center1
	...
	/**
	 * Sets the progress of the specified ProgressBar. Examples of ProgressBars
	 * are: {@link android.widget.SeekBar} and {@link android.widget.RatingBar}.
	 * 
	 * @param progressBar
	...
	/**
	 * Sets the status of a SlidingDrawer matching the specified index. Examples
	 * of status are: {@code Solo.CLOSED} and {@code Solo.OPENED}.
	 * 
	 * @param index
	 *            the index of the {@link SlidingDrawer}
	 * @param status
	 *            the status to set the {@link SlidingDrawer}
	 * 
	 */
	 ...
	 * {@code Solo.CLOSED} and {@code Solo.OPENED}.
	 * 
	 * @param slidingDrawer
	...
	public void enterTextInWebElement(By by, String text) {
		if (waiter.waitForWebElement(by, 0, Timeout.getSmallTimeout(), false) == null) {
			Assert.assertTrue("WebElement with " + webUtils.splitNameByUpperCase(by.getClass().getSimpleName()) + ": '" + by.getValue() + "' is not found!",
					false);
		}
	 ...
	 *            the text to enter in the {@link WebElement} field
	 * @param match
	 *            if multiple objects match, this determines which one will be
	 *            typed in
	 * 
	 */
	 ...
	 *            {@code By.name("name")}
	 * @param index
	 *            the index of the {@link WebElement}. {@code 0} if only one is
	 *            available
		...
		if (webElement == null) {
			if (match > 1) {
				Assert.assertTrue(match +
						" WebElements with " +
						webUtils.splitNameByUpperCase(by.getClass().getSimpleName()) +
						": '" +
						by.getValue() +
						"' are not found!", false);
			} else {
				Assert.assertTrue(
						"WebElement with " + webUtils.splitNameByUpperCase(by.getClass().getSimpleName()) + ": '" + by.getValue() + "' is not found!", false);
			}
		}
		return webElement;
	}
	 ...
	 * 
	 * @return an {@code ArrayList} of the {@link WebElement} objects currently
	...
	/**
	 * Returns an ArrayList of WebElements displayed in the active WebView
	 * matching the specified By object.
	 * 
	 * @param by
	 *            the By object. Examples are: {@code By.id("id")} and
	 *            {@code By.name("name")}
	 ...
	 * 
	 * @param text
	 *            the text that the {@link RadioButton} displays, specified as a
	 *            regular expression
	 * @return {@code true} if a {@link RadioButton} matching the specified text
	 *         is checked and {@code false} if it is not checked
	 * 
	 */
	 ...
	 * 
	 * @param text
	 *            the text that the {@link ToggleButton} displays, specified as
	 *            a regular expression
	 * @return {@code true} if a {@link ToggleButton} matching the specified
	 *         text is checked and {@code false} if it is not checked
	 * 
	 */
	 ...
	 * 
	 * @param text
	 *            the text that the {@link CheckBox} displays, specified as a
	 *            regular expression
	 * @return {@code true} if a {@link CheckBox} displaying the specified text
	 *         is checked and {@code false} if it is not checked
	 * 
	 */
	 ...
	 *            {@link CompoundButton} objects display, specified as a regular
	 *            expression
	 * @return {@code true} if the specified text is checked and {@code false}
	 *         if it is not checked
	 */
	...
	/**
	 * Checks if the specified text is selected in any Spinner located in the
	 * current screen.
	 * 
	 * @param text
	 *            the text that is expected to be selected, specified as a
	 *            regular expression
	 * @return {@code true} if the specified text is selected in any
	 *         {@link Spinner} and false if it is not
	 * 
	 */
	...
	/**
	 * Checks if the specified text is selected in a Spinner matching the
	 * specified index.
	 * 
	 * @param index
	 ...
	 *            the text that is expected to be selected, specified as a
	 *            regular expression
	 * @return {@code true} if the specified text is selected in the specified
	 *         {@link Spinner} and false if it is not
	 */
	 ...
	 * 
	 * @param name
	 *            the name of the {@link Activity} to return to. Example is:
	 *            {@code "MyActivity"}
	 * 
	 */
	...
	/**
	 * Waits for an Activity matching the specified name. Default timeout is 20
	 * seconds.
	 * 
	 * @param name
	 *            the name of the {@code Activity} to wait for. Example is:
	 *            {@code "MyActivity"}
	 ...
	 * 
	 * @param name
	 *            the name of the {@link Activity} to wait for. Example is:
	 *            {@code "MyActivity"}
	 * @param timeout
	 *            the amount of time in milliseconds to wait
	...
	/**
	 * Waits for an Activity matching the specified class. Default timeout is 20
	 * seconds.
	 * 
	 * @param activityClass
	 *            the class of the {@code Activity} to wait for. Example is:
	...
	/**
	 * Waits for a Fragment matching the specified tag. Default timeout is 20
	 * seconds.
	 * 
	 * @param tag
	 *            the name of the tag
	 * @return {@code true} if fragment appears and {@code false} if it does not
	...
	/**
	 * Waits for a Fragment matching the specified resource id. Default timeout
	 * is 20 seconds.
	 * 
	 * @param id
	...
	/**
	 * Waits for the specified log message to appear. Default timeout is 20
	 * seconds. Requires read logs permission (android.permission.READ_LOGS) in
	 * AndroidManifest.xml of the application under test.
	 * 
	 * @param logMessage
	 *            the log message to wait for
	 * @return {@code true} if log message appears and {@code false} if it does
	...
	/**
	 * Waits for the specified log message to appear. Requires read logs
	 * permission (android.permission.READ_LOGS) in AndroidManifest.xml of the
	 ...
	 * 
	 * @see #finishOpenedActivities() finishOpenedActivities() to close the
	...
	public void takeScreenshot(String name) {
		takeScreenshot(ScreenshotTaker.defaultScreenshotDir(), name, 100);
	}
	...
	public void takeScreenshot(String name, int quality) {
		screenshotTaker.takeScreenshot(ScreenshotTaker.defaultScreenshotDir(), name, quality);
	}
	...
	/**
	 * Takes a screenshot sequence and saves the images with the specified name
	 * prefix in "/sdcard/Robotium-Screenshots/".
	 * 
	 * The name prefix is appended with "_" + sequence_number for each image in
	 * the sequence, where numbering starts at 0.
	 * 
	 * Requires write permission (android.permission.WRITE_EXTERNAL_STORAGE) in
	 * AndroidManifest.xml of the application under test.
	 * 
	 * At present multiple simultaneous screenshot sequences are not supported.
	 * This method will throw an exception if stopScreenshotSequence() has not
	 * been called to finish any prior sequences. Calling this method is
	 * equivalend to calling startScreenshotSequence(name, 80, 400, 100);
	 * 
	 * @param name
	 ...
	 * 
	 * Requires write permission (android.permission.WRITE_EXTERNAL_STORAGE) in
	 * the AndroidManifest.xml of the application under test.
	 * 
	 * Taking a screenshot will take on the order of 40-100 milliseconds of time
	 * on the main UI thread. Therefore it is possible to mess up the timing of
	 * tests if the frameDelay value is set too small.
	 * 
	 * At present multiple simultaneous screenshot sequences are not supported.
	 * This method will throw an exception if stopScreenshotSequence() has not
	 * been called to finish any prior sequences.
	 * 
	 * @param name
	 *            the name prefix to give the screenshot
	 * @param quality
	 ...
	 * 
	 * If this method is not called to end a sequence and a prior sequence is
	 * still in progress, startScreenshotSequence() will throw an exception.
	 */
	...
	/**
	 * Initialize timeout using 'adb shell setprop' or use setLargeTimeout() and
	 * setSmallTimeout(). Will fall back to default hard coded values.
	 * 
	 */
	 ...
	 * 
	 * There are two options to set the timeout. Set it using adb shell: <br>
	 * <br>
	 * 'adb shell setprop solo_large_timeout milliseconds' <br>
	 * 'adb shell setprop solo_small_timeout milliseconds' <br>
	 * <br>
	 * Set the values directly using setLargeTimeout() and setSmallTimeout
	 * 
	 * @param property
	 *            name of the property to read the timeout from
	 * @param defaultValue
